    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                LoginOperation.GetUIConnection();

                Application.SBO_Application.SetStatusBarMessage("Add-on SBO_TREINAMENTO Conectado com Sucesso pela Servie Layer...", SAPbouiCOM.BoMessageTime.bmt_Short, false);
